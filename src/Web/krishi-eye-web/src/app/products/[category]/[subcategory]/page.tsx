...
export default function ProductSubcategoryPage({ params }: ProductSubcategoryPageProps) {
    ...
    const mockProducts = Array(16).fill(null).map((_, i) => ({
        id: i + 100,
        title: `${subcategoryName} Product ${i + 1}`,
        price: 500 + i * 150,
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-white border-b">
                <div className="container mx-auto px-4 md:px-8 py-4">
                    <div className="flex items-center gap-2 text-sm flex-wrap">
                        ...
                        <ChevronRight className="h-4 w-4 text-gray-400" />
                        <Link href={ROUTES.products.category(category)} className="text-gray-500 hover:text-primary">
                            {categoryName}
                        </Link>
                        <ChevronRight className="h-4 w-4 text-gray-400" />
            ...
            <div className="container mx-auto px-4 md:px-8 py-8">
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">{subcategoryName}</h1>
                        <p className="text-gray-600">{mockProducts.length}+ {subcategoryName.toLowerCase()} available</p>
                    </div>
                ...
                <div className="flex gap-6">
                    {/* Filters Sidebar - Same as main products page */}
                    ...
                    <div className="flex-1">
                        <InfiniteScrollProducts initialProducts={mockProducts} query={subcategoryName} viewMode={viewMode} />
                    </div>
                </div>
            </div>
        </div>
