            ...
            <div className="container mx-auto px-4 md:px-8 py-8">
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p className="text-gray-600">{mockProducts.length}+ {categoryName.toLowerCase()} products available</p>
                    </div>
                ...
                <div className="flex gap-6">
                    ...
                    <div className="flex-1">
                        <InfiniteScrollProducts initialProducts={mockProducts} query={categoryName} viewMode={viewMode} />
                    </div>
                </div>
            </div>
        </div>
